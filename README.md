...
2. Click **New bucket** and name the bucket exactly: `cloth_wash_assets`
...
4. Go to your `cloth_wash_assets` bucket and click on **Policies** (or **Policies** under the Storage configuration section in the left sidebar):
   * **Read Policy (Select)**:
